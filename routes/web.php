...
Route::get('/registers','UserController@create')->name('registers.create');
Route::post('/registers','UserController@store')->name('registers.store');

Route::get('/logins','UserController@createLogin')->name('logins.create');
Route::post('/logins','UserController@storeLogin')->name('logins.store');
